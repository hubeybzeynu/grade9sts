  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-background overflow-hidden">
      ...
      >
        ...
        <h1 className="text-2xl font-bold gradient-text mb-2">Welcome to Grade 9 Hub</h1>
        ...
        <motion.button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-card border border-border active:bg-muted transition-colors disabled:opacity-50"
        >
          {loading ? (
            <>
        ...
        <p className="text-xs text-muted-foreground mt-6 flex items-center justify-center gap-1">
          ...
          Your account info will be sent securely to the admin
        </p>
      </motion.div>
    </div>
  );
